...
class ODriveInterfaceAPI(object):
    ...
    def left_temperature(self):   return 0#self.left_axis.motor.motor_thermistor.temperature  if self.left_axis  else 0.
    def right_temperature(self):  return 0#self.right_axis.motor.motor_thermistor.temperature if self.right_axis else 0.
